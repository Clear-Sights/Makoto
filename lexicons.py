...
# `pyjwt`. Shared by 1.28 (verify=False / verify_signature) and 1.31 (algorithms=["none"]).
...
# on pattern 1.6 from precisely this shape — 'Saved 2026' (date prefix),
...
# extraction — lib.claims._code_spans (fences + inline backticks) and retraction._fenced_spans both consume
