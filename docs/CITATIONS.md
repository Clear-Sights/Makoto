...
The following entries exist so that internal Makoto documentation (specs, design docs, ADRs) can illustrate the citation-capture flow with real-world references without tripping pattern `content.phantom_citation` on the doc files themselves.
