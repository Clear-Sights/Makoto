"""FP-measurement runner for the gate.deadPureStatement Stop gate (formerly gate.liveness).
...
Test-support tooling only (see `makoto/tests/test_liveness_fp.py`) — not imported by any live
