"""content.timing_unsafe_compare predicate — timing-unsafe ==/!= comparison of a SECRET/HMAC/digest
...
Active-code only (substrate.factories.parse_introduced): a comment / string / docstring mentioning ``digest ==
