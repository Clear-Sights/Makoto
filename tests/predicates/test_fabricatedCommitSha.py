"""tests for content.fabricated_commit_sha (REVISED, makoto-1.22-revise) — fabricated commit SHA.
...
from makoto.checks.lineage import sha_predicate as predicate, _claimed_shas, _real_commit_in_history, _stop_text
