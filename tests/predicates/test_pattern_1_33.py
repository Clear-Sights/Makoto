...
from makoto.prechecks.precheck_1_33 import predicate
from makoto.schema import PreCheck

_PAT = PreCheck(id="1.33", fire_level="error", description='1.33 cert_reqs=ssl.CERT_NONE kwarg — peer-cert verification disabled at the call site', retry_hint="x")
