"""content.integrity_suppression_flag scope sentinels (graduation to BLOCKING, 2026-06-02).

content.integrity_suppression_flag was scoped to its MATERIAL core: an integrity-named suppression key as a
...
discrimination so a BLOCKING content.integrity_suppression_flag cannot regress into firing on documentation,
...
from makoto.checks.spec import suppress_predicate as predicate
...
# === NEAR-MISS NEGATIVES: must STAY SILENT (the FP classes content.integrity_suppression_flag was scoped out of)
