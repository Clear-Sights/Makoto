"""tests for content.verifier_predicate_weakened — verifier predicate weakened (loose-comparator shape).
...
from makoto.checks.spec import weakened_predicate as predicate
