...
"""
from makoto.prechecks.precheck_1_5 import predicate
from makoto.schema import PreCheck

_PAT = PreCheck(id="1.5", fire_level="error", description="DEFERRED checkbox theater", retry_hint="x")
...
def test_fires_on_checked_deferred_uppercase():
    ...
    assert f is not None and f.pattern_id == "1.5"
