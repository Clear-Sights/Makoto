"""makoto.substrate — the cohesive pool of shared helper modules (byte identity, claim
primitives, hook wiring, canon atoms, plan nodes, pytest-cache reads, the declared-id manifest);
siblings may import each other, per tests/test_import_direction.py's layout order.
